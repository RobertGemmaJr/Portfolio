...
public:
    ...
    */
    ...
    friend std::ostream &operator<<(std::ostream &os, const bigint &bigint1); // use << operator to print the bigint as a string with commas to the ostream.
    std::string scientific(unsigned int decimal_points = 3) const; // returns a string of the form "1.123E25" i.e. scientific notation with the given number of decimal points.
